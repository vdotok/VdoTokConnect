...
- (void)mqtt5UrlSession:(CocoaMQTT5 * _Nonnull)mqtt didReceiveTrust:(SecTrustRef _Nonnull)trust didReceiveChallenge:(NSURLAuthenticationChallenge * _Nonnull)challenge completionHandler:(void (^ _Nonnull)(enum NSURLSessionAuthChallengeDisposition, NSURLCredential * _Nullable))completionHandler;
///
...
- (void)mqttUrlSession:(CocoaMQTT * _Nonnull)mqtt didReceiveTrust:(SecTrustRef _Nonnull)trust didReceiveChallenge:(NSURLAuthenticationChallenge * _Nonnull)challenge completionHandler:(void (^ _Nonnull)(enum NSURLSessionAuthChallengeDisposition, NSURLCredential * _Nullable))completionHandler;
///
